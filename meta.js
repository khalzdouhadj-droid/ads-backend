...
// الخطوة 1: يوجه صاحب المتجر لصفحة تسجيل الدخول ديال Meta
// افتحي هذا الرابط في المتصفح: https://your-backend-url/auth/meta/login
...
// الخطوة 2: Meta ترجع هنا بعد الموافقة، ونبدل الكود بـ access token
...
// نقطة النهاية اللي تستخدمها لوحة التحكم لجلب أداء الحملات
